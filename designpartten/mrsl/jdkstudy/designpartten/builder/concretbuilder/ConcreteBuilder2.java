...
public class ConcreteBuilder2 implements Builder{
	...
	public void buildMethod1() {
		product1.getPart().add("建造者2用1方法对产品1进行了操作");
		product2.getPart().add("建造者2用1方法对产品2进行了操作");
	...
	public void buildMethod2() {
		...
		product1.getPart().add("建造者2用2方法对产品1进行了操作");
		product2.getPart().add("建造者2用2方法对产品2进行了操作");
	}
